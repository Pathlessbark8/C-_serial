...
__device__ void flux_Gxp_cuda(double Gxp[], double nx, double ny, double u1, double u2, double rho, double pr)
{
    double tx, ty, ut, un;
    double beta, S1, B1, A1pos;
    double temp1, temp2;
...
__device__ void flux_Gyn_cuda(double Gyn[], double nx, double ny, double u1, double u2, double rho, double pr)
{
    double tx, ty, ut, un;
    double beta, S2, B2, A2neg;
    double temp1, temp2;
