...
__device__ void flux_quad_GxI_cuda(double G[], double nx, double ny, double u1, double u2, double rho, double pr)
{
...
__device__ void flux_quad_GxII_cuda(double G[], double nx, double ny, double u1, double u2, double rho, double pr)
{
        double tx, ty, ut, un;
        double beta;
        double S1, B1, S2, B2;
...
__device__ void flux_quad_GxIII_cuda(double G[], double nx, double ny, double u1, double u2, double rho, double pr)
{
        double tx, ty, ut, un;
        double beta;
        double S1, B1, S2, B2;
...
__device__ void flux_quad_GxIV_cuda(double G[], double nx, double ny, double u1, double u2, double rho, double pr)
{
        double tx, ty, ut, un;
        double beta;
        double S1, B1, S2, B2;
