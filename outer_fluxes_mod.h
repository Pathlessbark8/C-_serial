...
__global__ void outer_dGx_pos_cuda(points &point, double VL_CONST, double gamma_new, int power)
{
    ...
    for (int j = 1; j <= point.xpos_nbhs[i]; j++)
    {
        ...
        flux_quad_GxIII_cuda(nx, ny, other_shared, true);

        venkat_limiter_cuda(point, other_shared, qtilde_shared, k, VL_CONST, gamma_new, delx, dely);
        flux_quad_GxIII_cuda(nx, ny, other_shared, false);
...
__global__ void outer_dGx_neg_cuda(points &point, double VL_CONST, double gamma_new, int power)
{
...

    {
        ...
        venkat_limiter_cuda(point, other_shared, qtilde_shared, i, VL_CONST, gamma_new, delx, dely);
        flux_quad_GxIV_cuda(nx, ny, other_shared, true);

        venkat_limiter_cuda(point, other_shared, qtilde_shared, k, VL_CONST, gamma_new, delx, dely);
        flux_quad_GxIV_cuda(nx, ny, other_shared, false);
